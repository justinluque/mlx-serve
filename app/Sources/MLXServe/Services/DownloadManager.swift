...
class DownloadManager: ObservableObject {
    ...
    /// already are.
    nonisolated static let internalHelperRepos: Set<String> = [nsfwClassifierRepo, "madebyollin/taef1", "madebyollin/taef2"]
    ...
    /// reasoning as `nsfwClassifierReady()` below, and the same fix as
