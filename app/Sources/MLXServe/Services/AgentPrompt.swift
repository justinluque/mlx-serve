...
enum AgentPrompt {
    ...
    [
      ...
      {"type":"function","function":{"name":"read_image","description":"Read an image file off disk and attach it to the conversation so you can actually SEE it — use this before describing, comparing or answering questions about a screenshot, photo or diagram the user pointed you at by path. Supports PNG, JPEG, GIF, BMP, TIFF and HEIC. The image is attached to your next reply, not returned as text. Example: {\"path\": \"screenshots/bug.png\"}","parameters":{"type":"object","properties":{"path":{"type":"string","description":"Image file path, relative to the working directory (or absolute)"}},"required":["path"]}}},
