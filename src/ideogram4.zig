...
/// The collector and the process-wide handle now live in `imatrix.zig` — both
/// halves of a pack feed the same file and they sit on opposite sides of the
/// flux import.
pub const Imatrix = imatrix_mod.Imatrix;
